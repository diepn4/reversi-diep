...
socket.on('game_update', (payload) => {
    ...
    /* Update my color */
    if (socket.id === payload.game.player_mint.socket){
        my_color = 'mint';
    }
        ...
        for (let column = 0; column < 8; column++){
            ...
            if (old_board[row][column] !== board[row][column]) {
                ...
                if ((old_board[row][column] === '?') && (board[row][column] ===' ')) {
                    ...
                    graphic = "empty_to_mint.gif";
                    altTag = "mint token";
                }
                else if ((old_board[row][column] === '?') && (board[row][column] ==='p')) {
                    graphic = "empty_to_purple.gif";
                    altTag = "purple token";
                }
                else if ((old_board[row][column] === ' ') && (board[row][column] ==='m')) {
                    graphic = "empty_to_mint.gif";
                    ...
                    graphic = "mint_to_empty.gif";
                    altTag = "empty space";
                }
                else if ((old_board[row][column] === 'p') && (board[row][column] ===' ')) {
                    graphic = "purple_to_empty.gif";
                    altTag = "empty space";
                }
                else if ((old_board[row][column] === 'm') && (board[row][column] ==='p')) {
                    graphic = "mint_to_purple.gif";
                    altTag = "purple token";
                }
                else if ((old_board[row][column] === 'p') && (board[row][column] ==='m')) {
                    graphic = "purple_to_mint.gif";
                    altTag = "mint token";
                }
                else {
                    graphic = "error.gif";
